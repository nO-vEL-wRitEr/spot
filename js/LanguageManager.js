class LanguageManager {
  ...
  ensureStyles() {
    ...
    style.textContent = `
      .spot-language-wrap{position:fixed;top:14px;right:max(14px,calc((100vw - min(100vw,412px))/2 + 14px));z-index:9998;display:flex;flex-direction:column;align-items:flex-end;gap:6px;pointer-events:none}
      ...
      @media (min-width:640px){.spot-language-wrap{top:26px}}
    `;
